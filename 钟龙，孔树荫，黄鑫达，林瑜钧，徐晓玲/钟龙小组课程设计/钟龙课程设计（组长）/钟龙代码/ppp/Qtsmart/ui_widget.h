...
**
** Created: Sat Jan 5 00:38:26 2019
...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        Widget->setStyleSheet(QString::fromUtf8("image: url(:/new/prefix1/11.jpg);"));
        widget = new QWidget(Widget);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(0, 0, 401, 301));
        widget->setAutoFillBackground(false);
        widget->setStyleSheet(QString::fromUtf8("image: url(:/new/prefix1/timg.jpg);"));
...
"font: 75 italic 14pt \"Ubuntu\";"));
        ...
        startthread_button = new QPushButton(widget);
...
"color: rgb(255, 0, 0);"));
        stopthread_button = new QPushButton(widget);
...
"border-image: url(:/new/prefix1/11.jpg);\n"
"image: url(:/new/prefix1/11.jpg);\n"
"font: 75 11pt \"Ubuntu\";\n"
