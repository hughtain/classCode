...
{	
	...
	{
		   h=strlen(ESP8266_Fram_Record_Struct .Data_RX_BUF);
		  
		  	
//		  
//		    for(t=0;t<h;t++)
//		{
//			 ESP8266_Fram_Record_Struct.Data_RX_BUFF[t]=ESP8266_Fram_Record_Struct .Data_RX_BUF[t];
//			
//		}
...
{
	//ESP8266_Send_AT_Cmd ( "AT+CWMODE=1", "OK", "no change", 2500 );
